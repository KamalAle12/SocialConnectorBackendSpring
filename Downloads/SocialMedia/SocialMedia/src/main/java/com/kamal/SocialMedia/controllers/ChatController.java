...
import com.kamal.SocialMedia.request.CreateChatRequest;
import com.kamal.SocialMedia.service.ChatService;
...
public class ChatController {
	...
	public List<Chat> findUsersChat(@RequestHeader("Authorization") String jwt) {
		...
		List<Chat> chats = chatService.findUsersChar(user.getId());
